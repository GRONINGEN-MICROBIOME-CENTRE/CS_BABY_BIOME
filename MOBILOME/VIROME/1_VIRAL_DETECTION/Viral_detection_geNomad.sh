...
rsync -av ${sample_dir}/${SAMPLE_ID}/virome_discovery/geNomad_results/${SAMPLE_ID}_metaspades_scaffolds_summary/*metaspades_scaffolds_virus.fna ${sample_dir}/${SAMPLE_ID}/virome_discovery/geNomad/
rsync -av ${sample_dir}/${SAMPLE_ID}/virome_discovery/geNomad_results/${SAMPLE_ID}_metaspades_scaffolds_summary/*metaspades_scaffolds_virus_summary.tsv ${sample_dir}/${SAMPLE_ID}/virome_discovery/geNomad/
